...
/*   Updated: 2022/11/08 20:08:32 by dmontema         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Socket::Socket()
{
	this->_server_fd = socket(AF_INET6, SOCK_STREAM, 0);
	if (this->_server_fd < 0)
		throw NoSocketException();
	initSockAddr();
	if (this->_bind < 0)
		throw NoBindException();
	this->_listen = listen(this->_server_fd, 1);
	if(this->_listen < 0)
		throw NoListenException();
	this->_newSocket = accept(this->_server_fd, (struct sockaddr *)&this->_address, (socklen_t*) sizeof(this->_address));
...
void Socket::initSockAddr()
{
	...
	this->_bind = bind(this->_server_fd,(struct sockaddr *) &_address, sizeof(_address));
